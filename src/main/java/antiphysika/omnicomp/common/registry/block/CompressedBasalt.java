...
public class CompressedBasalt
{
  ...
  public static void init ()
  {
    ...
    ITEM_1X = Registrar.ITEMS.registerSimpleBlockItem("basalt_1x", BLOCK_1X);
    ITEM_2X = Registrar.ITEMS.registerSimpleBlockItem("basalt_2x", BLOCK_2X);
    ITEM_3X = Registrar.ITEMS.registerSimpleBlockItem("basalt_3x", BLOCK_3X);
  }
}
