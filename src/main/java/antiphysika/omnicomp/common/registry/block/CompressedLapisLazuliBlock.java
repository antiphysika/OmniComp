...
public class CompressedLapisLazuliBlock
{
  ...
  public static void init ()
  {
    BLOCK_1X = Registrar.registerBlock(
      "lapis_lazuli_block_1x",
      2.0f,
      MapColor.LAPIS
    );

    BLOCK_2X = Registrar.registerBlock(
      "lapis_lazuli_block_2x",
      3.5f,
      MapColor.LAPIS
    );

    BLOCK_3X = Registrar.registerBlock(
      "lapis_lazuli_block_3x",
      5.0f,
      MapColor.LAPIS
    );

    ITEM_1X = Registrar.ITEMS.registerSimpleBlockItem("lapis_lazuli_block_1x", BLOCK_1X);
    ITEM_2X = Registrar.ITEMS.registerSimpleBlockItem("lapis_lazuli_block_2x", BLOCK_2X);
    ITEM_3X = Registrar.ITEMS.registerSimpleBlockItem("lapis_lazuli_block_3x", BLOCK_3X);
  }
}
