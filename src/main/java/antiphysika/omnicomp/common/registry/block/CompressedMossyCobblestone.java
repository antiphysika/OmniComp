...
public class CompressedMossyCobblestone
{
  ...
  public static void init ()
  {
    BLOCK_1X = Registrar.registerBlock(
      "mossy_cobblestone_1x",
      2.0f,
      MapColor.COLOR_GREEN
    );

    BLOCK_2X = Registrar.registerBlock(
      "mossy_cobblestone_2x",
      3.5f,
      MapColor.COLOR_GREEN
    );

    BLOCK_3X = Registrar.registerBlock(
      "mossy_cobblestone_3x",
      5.0f,
      MapColor.COLOR_GREEN
    );

    ITEM_1X = Registrar.ITEMS.registerSimpleBlockItem("mossy_cobblestone_1x", BLOCK_1X);
    ITEM_2X = Registrar.ITEMS.registerSimpleBlockItem("mossy_cobblestone_2x", BLOCK_2X);
    ITEM_3X = Registrar.ITEMS.registerSimpleBlockItem("mossy_cobblestone_3x", BLOCK_3X);
  }
}
