...
public class CompressedGoldBlock
{
  ...
  public static void init ()
  {
    ...
    ITEM_1X = Registrar.ITEMS.registerSimpleBlockItem("gold_block_1x", BLOCK_1X);
    ITEM_2X = Registrar.ITEMS.registerSimpleBlockItem("gold_block_2x", BLOCK_2X);
    ITEM_3X = Registrar.ITEMS.registerSimpleBlockItem("gold_block_3x", BLOCK_3X);
  }
}
