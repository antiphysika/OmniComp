...
public class CompressedDiorite
{
  ...
  public static void init ()
  {
    ...
    ITEM_1X = Registrar.ITEMS.registerSimpleBlockItem("diorite_1x", BLOCK_1X);
    ITEM_2X = Registrar.ITEMS.registerSimpleBlockItem("diorite_2x", BLOCK_2X);
    ITEM_3X = Registrar.ITEMS.registerSimpleBlockItem("diorite_3x", BLOCK_3X);
  }
}
